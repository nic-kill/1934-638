...
foreach dest ( 2016-04*.uv.split 2016-05*.uv.split 2016-08*.uv.split 2016-11*.uv.split 2017-02*.uv.split 2019*.uv.split )
	...
	if ( ${dest} =~ 2016-04*.uv.split 2016-05*.uv.split ) uvflag vis=1934-638.1420.5.6_flaggedHI line=channel,230,3000,1,1 flagval=f |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
	...
	if ( ${dest} =~ 2019*.uv.split ) uvflag vis=1934-638.1420.5.4_flaggedHI line=channel,200,3080,1,1 flagval=f |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
	...
	if ( ${dest} =~ 2016-04*.uv.split 2016-05*.uv.split ) uvflag vis=1934-638.1419.5.2 line=channel,200,970,1,1 flagval=f |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
	if ( ${dest} =~ 2016-04*.uv.split 2016-05*.uv.split ) uvflag vis=1934-638.1419.5.6 line=channel,200,970,1,1 flagval=f |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
	if ( ${dest} =~ 2016-08*.uv.split ) uvflag vis=1934-638.1419.5.2 line=channel,220,1350,1,1 flagval=f |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
        if ( ${dest} =~ 2016-08*.uv.split ) uvflag vis=1934-638.1419.5.6 line=channel,220,1350,1,1 flagval=f |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
        ...
        if ( ${dest} =~ 2016-11*.uv.split ) uvflag vis=1934-638.1419.5.6 line=channel,250,1300,1,1 flagval=f |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
	...
	if ( ${dest} =~ 2017-02*.uv.split ) uvflag vis=1934-638.1419.5.6 line=channel,200,1050,1,1 flagval=f |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
	...
	cp -rf 1934-638.1419.5.6/bandpass 1934-638.1420.5.6_flaggedHI/bandpass |& tee -a /priv/myrtle1/gaskap/nickill/1934project/uvfiles/miriadcal.log
